...
const OUT_DIR = path.join(__dirname, '../e2e/iphone-14-plus')
...
const SUITES: SuiteSpec[] = [
  ...
  },
  {
    ...
    suite: 'iPhone 14 Plus – Export PDF',
    count: 40,
    topics: [
  ...
  },
  {
    ...
    suite: 'iPhone 14 Plus – Edge cases',
    count: 40,
    topics: [
      'offline gate page',
      'offline PIN shell',
...
`,
  ...
  console.log(`\n🎉 Generated ${total} scaffold tests in e2e/iphone-14-plus/`)
}
