...
test.describe('iPhone 14 Plus – Edge cases', () => {
  ...
  test.skip('edge-cases-004: API timeout retry', async () => {
    // Scaffold – implement when Edge cases is finalized.
    // Topic: API timeout retry
  })

  test.skip('edge-cases-005: 500+ transaction render', async () => {
    // Scaffold – implement when Edge cases is finalized.
    // Topic: 500+ transaction render
  })

  test.skip('edge-cases-006: memory on long scroll', async () => {
    // Scaffold – implement when Edge cases is finalized.
  ...
  test.skip('edge-cases-008: rotate during transfer modal', async () => {
    // Scaffold – implement when Edge cases is finalized.
    // Topic: rotate during transfer modal
  })

  test.skip('edge-cases-009: low battery mode throttling', async () => {
    // Scaffold – implement when Edge cases is finalized.
    // Topic: low battery mode throttling
  })

  test.skip('edge-cases-010: service worker cache hit', async () => {
    // Scaffold – implement when Edge cases is finalized.
    // Topic: service worker cache hit
  })

  test.skip('edge-cases-011: push permission prompt', async () => {
    // Scaffold – implement when Edge cases is finalized.
    // Topic: push permission prompt
  })

  test.skip('edge-cases-012: duplicate payment submit', async () => {
    // Scaffold – implement when Edge cases is finalized.
    // Topic: duplicate payment submit
  })

  test.skip('edge-cases-013: stale balance after payment', async () => {
    // Scaffold – implement when Edge cases is finalized.
  ...
  test.skip('edge-cases-016: deep link dashboardpayment', async () => {
    // Scaffold – implement when Edge cases is finalized.
    // Topic: deep link dashboardpayment
  })

  test.skip('edge-cases-017: site gate wrong password', async () => {
    // Scaffold – implement when Edge cases is finalized.
    // Topic: site gate wrong password
  })

  test.skip('edge-cases-018: site gate empty password', async () => {
    // Scaffold – implement when Edge cases is finalized.
  ...
  test.skip('edge-cases-020: PWA standalone viewport', async () => {
    // Scaffold – implement when Edge cases is finalized.
    // Topic: PWA standalone viewport
  })

  test.skip('edge-cases-021: offline gate page (variant 2)', async () => {
    // Scaffold – implement when Edge cases is finalized.
    // Topic: offline gate page
  })
  ...
  test.skip('edge-cases-025: 500+ transaction render (variant 2)', async () => {
    // Scaffold – implement when Edge cases is finalized.
    // Topic: 500+ transaction render
  })

  test.skip('edge-cases-026: memory on long scroll (variant 2)', async () => {
    // Scaffold – implement when Edge cases is finalized.
    // Topic: memory on long scroll
  })
  ...
  test.skip('edge-cases-029: low battery mode throttling (variant 2)', async () => {
    // Scaffold – implement when Edge cases is finalized.
    // Topic: low battery mode throttling
  })

  test.skip('edge-cases-030: service worker cache hit (variant 2)', async () => {
    // Scaffold – implement when Edge cases is finalized.
    // Topic: service worker cache hit
  })

  test.skip('edge-cases-031: push permission prompt (variant 2)', async () => {
    // Scaffold – implement when Edge cases is finalized.
    // Topic: push permission prompt
  })

  test.skip('edge-cases-032: duplicate payment submit (variant 2)', async () => {
    // Scaffold – implement when Edge cases is finalized.
    // Topic: duplicate payment submit
  })

  test.skip('edge-cases-033: stale balance after payment (variant 2)', async () => {
    // Scaffold – implement when Edge cases is finalized.
    // Topic: stale balance after payment
  })
  ...
  test.skip('edge-cases-037: site gate wrong password (variant 2)', async () => {
    // Scaffold – implement when Edge cases is finalized.
    // Topic: site gate wrong password
  })

  test.skip('edge-cases-038: site gate empty password (variant 2)', async () => {
    // Scaffold – implement when Edge cases is finalized.
    // Topic: site gate empty password
  })
